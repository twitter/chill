 ...
 *
 * This method isn't safe since calling get on an Externalizer[T] could still throw despite the inversion here
 * having worked as advertized. Since it is at the point of the get we unpack the inner box.
 */
